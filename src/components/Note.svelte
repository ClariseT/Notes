...
function handleChange() {
    dispatch('update', {     /*evento personalizado p/actualizar datos de notes --- en este caso utilizo un bind*/
        id: id,
		title:title,
		color: color,
		text:text
...
<div class="Note">
    <div class="Note_container" style={'background-color: '+ color}>
        <div class="header">
            <div class="options">
    ...
    <div class="content">
        <div class="title">
            <input placeholder="Agregar titulo " bind:value={title} on:change={handleChange}>
        </div>
        <textarea placeholder="Escribir..." cols="30" rows="10" on:change={handleChange}  bind:value={text}></textarea>
    </div>
